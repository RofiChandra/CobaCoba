...
public class sign_up_goal extends AppCompatActivity {
    ...
    public void sign_up_goal_submit() {
        /* Open database */
        ...
        if(errorMessage.isEmpty()){
            Intent i = new Intent(sign_up_goal.this, MainActivity.class);
            startActivity(i);
        }
     //signUpGoalSubmit
    }
